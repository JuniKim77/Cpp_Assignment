...
int main()
{
	...
	Game game(1, 4);
	std::vector<IceCube*> activeGameObjects = game.GetActiveGameObjects();
	...
	activeGameObjects = game.GetActiveGameObjects();
	...
	std::vector<IceCube*> activeGameObjects2 = game.GetActiveGameObjects();
	...
	assert(activeGameObjects[4] == activeGameObjects2[3]);

	auto& op2 = game.GetObjectPool();
	IceCube* i5 = op2.Get();

	assert(i5 == activeGameObjects[3]);
