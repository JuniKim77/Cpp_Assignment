...
using namespace CustomizedVector;
...
int main()
{
	...
	for (int i = 0; i < boolVector1.GetSize(); i++)
	{
		std::cout << boolVector1.Get(i);
		if (i % 32 == 31)
		{
			std::cout << std::endl;
		}
	...
	for (int i = 0; i < boolVector2.GetSize(); i++)
	{
		std::cout << boolVector2.Get(i);
		if (i % 32 == 31)
		{
			std::cout << std::endl;
		}
